...
export default async function ProtectRoutesPage() {
    ...
    return (
        <Guide title={title} previous={previousLink} next={nextLink}>
            ...
            <Image src="/images/screenshot-8.png" className="img-fluid mb-4" alt="screenshot-8"/>
            ...
            <Image src="/images/screenshot-9.png" className="img-fluid mb-4" alt="screenshot-9"/>
        </Guide>
    );
}
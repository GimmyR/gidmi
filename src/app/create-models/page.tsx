...
export default async function CreateModelsPage() {
    ...
    return (
        <Guide title={title} previous={previousLink} next={nextLink}>
            ...
            <img src="/images/screenshot-10.png" className="img-fluid mb-4"/>
            ...
            <img src="/images/screenshot-11.png" className="img-fluid mb-4"/>
            ...
            <img src="/images/screenshot-12.png" className="img-fluid mb-4"/>
        </Guide>
    );
}
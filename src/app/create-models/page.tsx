...
export default async function CreateModelsPage() {
    ...
    return (
        <Guide title={title} previous={previousLink} next={nextLink}>
            ...
            <Image src="/images/screenshot-10.png" className="img-fluid mb-4" alt="screenshot-10"/>
            ...
            <Image src="/images/screenshot-11.png" className="img-fluid mb-4" alt="screenshot-11"/>
            ...
            <Image src="/images/screenshot-12.png" className="img-fluid mb-4" alt="screenshot-12"/>
        </Guide>
    );
}